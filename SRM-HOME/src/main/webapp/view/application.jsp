...
<div>
    ...
    <div class="container-xxl position-relative bg-white p-0">
        ...
        <div class="content open">
			...
			<!-- 초기화 신청 시작 -->
			<div class="container-fluid pt-4 px-4">
			    <div class="bg-light text-center rounded p-4" style="max-height:400px; min-height:400px">
			        <h6 class="mb-4">암호초기화 실행</h6>
			        <div class="table-responsive" style="background-color:white; max-height:300px; min-height:300px; overflow-y:scroll">
