...
<body>
	<div>
		 <div class="fixed-top form-control-sm" style="height:30px">
		 	<nav class="navbar navbar-expand bg-light navbar-light sticky-top" style="float:right">
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-2" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                            <span class="d-none d-lg-inline-flex">ICT금융부 남물구 과장(7150077)</span>
                        </a>
	            ...
	            <!-- Navbar End -->
				 ...
				 <div class="container-fluid pt-4 px-4">
	                <div class="row g-4">
	                    ...
	                    <div class="col-sm-6 col-xl-3">
	                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
	                            <i class="bi bi-file-earmark-break-fill fa-2x text-primary"></i>
	                    ...
	                    <div class="col-sm-6 col-xl-3">
	                        <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
	                            <i class="bi bi-card-checklist fa-2x text-primary"></i>
